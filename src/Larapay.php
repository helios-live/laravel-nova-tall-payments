...
use IdeaToCode\LaravelNovaTallPayments\Contracts\InvoiceManager;
...
use IdeaToCode\LaravelNovaTallPayments\Errors\InvalidGateway;
use IdeaToCode\LaravelNovaTallPayments\Errors\InvoiceAlreadyPaid;
use IdeaToCode\LaravelNovaTallPayments\Facades\Larapay as LarapayFacade;
...
class Larapay
{
    ...
    public function __construct(InvoiceManager $manager = null)
    {
        ...
        $this->gateways = [
            'admin' => [
                'name' => 'Admin',
                'class' => 'IdeaToCode\\LaravelNovaTallPayments\\Payments\\ManualGateway',
            ...
            'stripe' => [
                'name' => 'Stripe',
                'class' => 'IdeaToCode\\LaravelNovaTallPayments\\Payments\\StripeGateway',
            ...
            'paypal' => [
                'name' => 'Paypal',
                'class' => 'IdeaToCode\\LaravelNovaTallPayments\\Payments\\PaypalGateway',
            ...
            'bitcoin' => [
                'name' => 'Bitcoin',
                'class' => 'IdeaToCode\\LaravelNovaTallPayments\\Payments\\BitcoinGateway',
            ...
            'coinbase' => [
                'name' => 'Coinbase',
                'class' => 'IdeaToCode\\LaravelNovaTallPayments\\Payments\\CoinbaseGateway',
    ...
    /**
     * @see \IdeaToCode\LaravelNovaTallPayments\Contracts\InvoiceManager
